...
DELETE FROM `spell_script_names` WHERE `ScriptName` IN (
    ...
    'PestifereExcroissanceAuraScript',
    ...
    'PestifereJetDeSangSpellScript',
    'PestiferePousseeDeSangSpellScript',
...
(90230, 'PestifereExcroissanceAuraScript'),
...
(90296, 'PestifereJetDeSangSpellScript'),
(90297, 'PestiferePousseeDeSangSpellScript'),
